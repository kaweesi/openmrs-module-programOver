 ...
 */
package org.openmrs.module.programOver.extension.html;
...
public class AdminList extends AdministrationSectionExt {
	...
	public String getTitle() {
		String title = "Program Statistics Module";
		return title;
	}
	...
	public Map<String, String> getLinks() {
		...
		for (Program p : Context.getProgramWorkflowService().getAllPrograms()) {
			...
			if (p.getProgramId() == Integer.parseInt(GlobalProperties.gpGetHIVProgramId())){
			
			map.put("module/programOver/programoverLink.form?programId=" + p.getProgramId(), p.getName());
			}
		}
...
@Override
    ...
    // TODO Auto-generated method stub
	    ...
	    return "View Program Statistics Module" ;
	}
